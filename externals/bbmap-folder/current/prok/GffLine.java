...
//		assert(seqid!=null) : new String(line, a, b-a)+", "+a+", "+b+"\n"+line;
		...
		else{score=Tools.parseFloat(line, a, b);}
		b++;
		a=b;
...
//		assert(strand>=0) : "\n"+this.toString()+"\n"+new String(line);
	...
	public static ArrayList<GffLine>[] loadGffFileByType(FileFormat ff, String types){
		ArrayList<GffLine> list=loadGffFile(ff, types);
