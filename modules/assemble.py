...
class mainprocess(object) :
    ...
    def _flye_dedup(self, input_name, output_name) :
    ...
    def do_flye(self, reads, contigs, isMetagenome) :
        ...
        if contigs :
            ...
            if flye_run.returncode != 0 :
                sys.exit(20123)
            asm2 = self._flye_dedup('{outdir2}/assembly.fasta'.format(outdir2=outdir2), '{outdir2}/assembly.dedup.fasta'.format(outdir2=outdir2))
